        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          {user ? (
            ...
            <div className="w-full space-y-4">
              <button
                className={`relative w-full h-14 bg-red-600 hover:bg-red-500 active:bg-red-700 text-white font-semibold rounded-2xl transition duration-200 shadow-lg shadow-red-950/20 flex items-center justify-center space-x-3 cursor-pointer group ${loading ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
                onClick={googleLogin}
                disabled={loading}
              >
